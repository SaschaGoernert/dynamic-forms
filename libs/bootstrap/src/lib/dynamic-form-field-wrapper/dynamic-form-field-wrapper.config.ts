...
import { BsDynamicFormFieldPanelComponent } from './dynamic-form-field-panel/dynamic-form-field-panel.component';
...
export const bsDynamicFormFieldWrapperConfig: DynamicFormFieldWrapperConfig = {
  types: [
    ...
    { type: 'panel', component: BsDynamicFormFieldPanelComponent }
  ]
};
